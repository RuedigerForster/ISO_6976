...
r25_0 <- calculateProperties(fractionArray, uncertaintyArray, correlationMatrix,
                             combustionTemperature = 25,
                             volumeTemperature     = 0)

# UK/legacy standard: 15 °C / 15 °C
r15_15 <- calculateProperties(fractionArray, uncertaintyArray, correlationMatrix,
                              combustionTemperature = 15,
                              volumeTemperature     = 15)
...
r_k1 <- calculateProperties(fractionArray, uncertaintyArray, correlationMatrix,
                             combustionTemperature = 15, volumeTemperature = 15,
                             coverage = 1)
r_k2 <- calculateProperties(fractionArray, uncertaintyArray, correlationMatrix,
                             combustionTemperature = 15, volumeTemperature = 15,
                             coverage = 2)
